...
func (s *Seed) categoriesSeed() {
	categoryMaps := []map[string]any{
		{"name": "Food & Beverage", "desc": "Food and beverage products"},
		{"name": "Travel", "desc": "Travel and tourism services"},
		{"name": "Technology", "desc": "Technology products and gadgets"},
		{"name": "Art & Crafts", "desc": "Art and craft supplies and materials"},
		{"name": "Jewelry", "desc": "Jewelry and accessories"},
		{"name": "Pet Supplies", "desc": "Pet food, supplies, and accessories"},
		{"name": "Books & Stationery", "desc": "Books, stationery, and office supplies"},
		{"name": "Health & Beauty", "desc": "Health and beauty products"},
		{"name": "Automotive", "desc": "Automotive parts, accessories, and services"},
		{"name": "Home & Garden", "desc": "Home and garden supplies and equipment"},
		{"name": "Clothing", "desc": "Clothing and accessories"},
		{"name": "Electronics", "desc": "Electronics and gadgets"},
		{"name": "Sports & Fitness", "desc": "Sports and fitness equipment and accessories"},
		{"name": "Toys & Games", "desc": "Toys, games, and entertainment products"},
		{"name": "Office Supplies", "desc": "Office supplies and equipment"},
	}
